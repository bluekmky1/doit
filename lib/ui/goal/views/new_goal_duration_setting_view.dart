...
class NewGoalDurationSettingView extends ConsumerStatefulWidget {
  const NewGoalDurationSettingView({super.key});

  @override
  ConsumerState<NewGoalDurationSettingView> createState() =>
      _NewGoalDurationSettingViewState();
}

class _NewGoalDurationSettingViewState
    extends ConsumerState<NewGoalDurationSettingView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
            context.goNamed(Routes.goalSetting.name);
          },
