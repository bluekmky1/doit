...
final AutoDisposeStateNotifierProvider<GoalViewModel, GoalState>
    goalViewModelProvider = StateNotifierProvider.autoDispose(
  (Ref ref) => GoalViewModel(
    state: const GoalState.init(),
  ),
);
